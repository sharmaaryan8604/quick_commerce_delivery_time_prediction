  ...
  return (
    <div className="blog-shell">
      <section className="blog-hero">
        ...
        <h1 className="blog-title">Delivery model evaluation</h1>
        <p className="blog-lead">A compact readout of the current comparison so the deployment choice is easy to review.</p>
      ...
      <div className="blog-grid">
          ...
          <div className="post-section">
            <div className="insight-grid">
              <div className="insight">
                ...
                <div className="insight-label">RMSE</div>
              </div>
              <div className="insight">
                <div className="insight-value">{top ? fmt(top.MAE, 3) : "--"}</div>
                <div className="insight-label">MAE</div>
              </div>
              <div className="insight">
                <div className="insight-value">{top ? fmt(top.R2, 4) : "--"}</div>
                <div className="insight-label">R2</div>
              </div>
              <div className="insight">
              ...
              {ordered.map((item) => (
                <div className="eval-card" key={item.Model}>
                  ...
                  <div className="eval-stats">
                    <span><span className="metric-rename">RMSE</span> {fmt(item.RMSE)}</span>
                    <span><span className="metric-rename">MAE</span> {fmt(item.MAE)}</span>
                    <span><span className="metric-rename">R2</span> {fmt(item.R2, 4)}</span>
                    <span><span className="metric-rename">MAPE</span> {fmt(item.MAPE, 3)}%</span>
                    <span><span className="metric-rename">CV RMSE</span> {fmt(item.CV_RMSE)}</span>
        ...
        <aside className="side">
          <div className="aside-block">
            <div className="aside-title">How to read this</div>
            <p className="aside-copy">
              Lower RMSE and MAE are better. Higher R2 is better. The live pipeline should always align with the best saved model.
            </p>
